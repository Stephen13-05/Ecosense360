...
def carbon_footprint(request):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            # Transport Footprint (Only if the user has selected those transport modes)
    ...
    return render(request, "registration/carbon.html", {"form": form, "carbon_footprint": total_footprint})
